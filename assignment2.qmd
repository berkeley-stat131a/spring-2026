...
Due date: **Sunday, February 29 at 11:59PM**.
...
In this exercise we are going to explore (via a computer simulation) what would happen if I made the wrong model assumption 

make a plot showing the pdf of the 
create a histogram
