...
Stat 131A is an upper-division course that follows Data 8 or STAT 20.
...
-   Final project: 20%
-   Exams: 40% 
    - 20% greatest(final_part_1, 50% * midterm + 50% * final_part_1)
    - 20% final_part_2
...
- **Grades will not be curved.** - In other words, there is no limit to the proportion of students with an A, B, etc. **You are incentivized to help each other learn. This is not the place for competition.**
...
Only exceptions are students with Letters of Accommodations.
...
The first midterm is scheduled for **TBD** and will take place during lecture in Weill 101. 
